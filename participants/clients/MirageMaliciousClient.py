...
class MirageMaliciousClient(AbstractClient):
    ...
    def generate_discriminator_dataloader(self, model, train_loader):
        ...
        for i in range(class_num):
            ...
            poisoned_sample, _ = self._poisoned_batch_injection((samples, labels),evaluation=False)
