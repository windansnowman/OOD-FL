    ...
    def _create_model(self):
        ...
        if "ResNet" in self.params["model_type"]:
            if self.params["dataset"].upper() == "CIFAR10":
                ...
                local_model = getattr(models.resnet, self.params["model_type"])(num_classes=200, dataset="CIFAR")
            ...
            if self.params["dataset"].upper() == "CIFAR10":
                local_model = getattr(models.cnn, self.params["model_type"])(num_classes=10)
            elif self.params["dataset"].upper() == "CIFAR100":
                local_model = getattr(models.cnn, self.params["model_type"])(num_classes=100)
