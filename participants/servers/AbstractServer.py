...
class AbstractServer():
    ...
    def __init__(self, params, current_time):
        ...
        self.folder_path = f"./saved_models/{self.current_time}_{self.params['dataset']}_{self.params['malicious_train_algo']}_{self.params['defense_method']}"
        try:
    ...
    def _create_model(self):
        ...
        if "ResNet" in self.params["model_type"]:
            if self.params["dataset"].upper() == "CIFAR10":
                ...
                global_model = getattr(models.resnet, self.params["model_type"])(num_classes=200, dataset="CIFAR")
            ...
            if self.params["dataset"].upper() == "CIFAR10":
                global_model = getattr(models.cnn, self.params["model_type"])(num_classes=10)
            elif self.params["dataset"].upper() == "CIFAR100":
                global_model = getattr(models.cnn, self.params["model_type"])(num_classes=100)
